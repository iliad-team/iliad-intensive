...
% learningOutcomes:
%   - Define the Bayesian mixture over a class of environments and prove it is a proper
%     predictor whose posterior updates multiplicatively.
%   - Prove the cumulative prediction-error bound and specialize it to the Solomonoff
%     prior to recover the Occam bound.
%   - Show the mixture makes boundedly many mistakes and is Pareto-optimal under KL and
%     squared loss.
...
\title{Solomonoff Induction Exercises}
\author{David Quarel \and Leon Lang}
\date{\today}
\maketitle
