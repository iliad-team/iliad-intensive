...
\begin{align}
    P(f) &= \int dc\,Dz\, P(c,z)\, \delta\Big(f(x)-\tfrac{1}{\sqrt N}c\cdot \phi(z(x))\Big) \\
     ...
     & \hspace{1in} {}^{\textstyle + i\int dx \tilde f(x)(f(x)-\frac{1}{\sqrt N}c\cdot \phi(z(x))) \Big]} \\
     & \hspace{-.2in} = \frac{1}{Z'''} \int Dz\,D\tilde f\, e^{\textstyle \Big[- \frac{1}{2\sigma_w} \int dx\,dx'\,  \big(\frac{x\cdot x'}{d}\big)^{-1}z(x)\cdot z(x') \Big.} \notag \\
     & \hspace{.6in} {}^{\textstyle - \frac{\sigma_w}{2N} \int dx\,dx' \tilde f(x)[\phi(z(x))\cdot \phi(z(x'))]\tilde f(x') +i\int dx\, \tilde f(x) f(x)\Big]}
\end{align}
%
...
%
\begin{align}
    P(f) &= \frac{1}{Z''''} \int D\tilde f\, e^{\textstyle -\frac{1}{2} \int dx\, dx'\, \tilde f(x) \bar K^{(2)}(x,x') \tilde f(x') + i\int dx\, \tilde f(x) f(x)} \notag \\
     & \hspace{2.2in} + O\Big(\frac{1}{N}\Big) \\
