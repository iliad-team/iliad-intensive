...
summary: TODO
contributors:
  - Leon Lang (University of Amsterdam), based on work by Alex Turner
slides: https://drive.google.com/drive/folders/1RhDCQ1Cpm-R9BciquvTgT-WcFV48Kjbk
---
...
Go through [these slides](https://drive.google.com/file/d/1VxQGC_tuWvV2kJdV980ItU7twRvx2ZU9/view?usp=sharing).

## Main content

The core content today [is this worksheet](https://drive.google.com/file/d/1Vwhd-cAiqgbd1wqCQWYhHnGyGMs8yiGl/view?usp=sharing),. A brief summary is in the slides from above.
