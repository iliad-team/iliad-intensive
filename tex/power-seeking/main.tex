...
Finally, the brainstormings of limitations and ideas gets participants into a
...
\begin{itemize}
  ...
  \item The use of score functions allows us to achieve a power-seeking result for one-sided dynamics embeddings and under non-trivial discount factor.
\end{itemize}
