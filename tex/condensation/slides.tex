...
%--- end ---
% Lecture 1. Uses the companion clustering illustration.
...
\centering
\IfFileExists{fig/hierarchical-points.pdf}{\includegraphics[width=0.98\linewidth,height=5.0cm,keepaspectratio]{fig/hierarchical-points.pdf}}{\includegraphics[width=0.98\linewidth,height=5.0cm,keepaspectratio]{../condensation-clustering/fig/hierarchical-points.pdf}}
