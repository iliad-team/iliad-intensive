...
% Shared contract pieces (learningoutcomes box, marks) from iliad.sty in
% compat mode: defines only what this legacy preamble is missing. Local
% copy wins (Overleaf); falls back to the shared ../iliad.sty in the repo.
