...
% learning-outcomes box (normally from ../iliad.sty, which this sheet predates)
\newenvironment{learningoutcomes}{\par\medskip\noindent\textbf{What you'll learn.}\begin{itemize}}{\end{itemize}\medskip}
