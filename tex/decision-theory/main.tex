...
%   - Fernando E. Rosas
% learningOutcomes:
%   - Explain when preference relations over trajectories admit ordinal utility
%     representations, and what fails without completeness or transitivity.
%   - State and prove the von Neumann--Morgenstern theorem, and distinguish
%     ordinal from cardinal utility.
%   - Derive the Markov reward representation from the temporal
%     gamma-indifference axiom, and explain reward non-uniqueness and
...
% Contract aside environment (renders as a note callout on the web)
\newenvironment{callout}[1][note]{%
  \begin{tcolorbox}[colback=gray!10, colframe=black!60, before upper={\parindent12pt}]%
}{%
  \end{tcolorbox}%
}
