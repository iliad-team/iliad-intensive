...
% The three bullets that used to sit here were machine-written, not Fernando's:
% notes_vNM/main.tex has no outcomes list at all, and none of its sentences
% matched them. His own three are recorded on the D.1 Doc tab, under the
% "idealised agency" dump -- transcribe those, or ask him:
%
...
%   * Be able to derive the relationship between various preference structures
%     and rationality axioms.
%   * Critically assess alternative notions of rationality, and the
