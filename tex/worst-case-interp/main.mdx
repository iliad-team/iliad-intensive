...
* Read the intro <NotebookNoSol name="compact_proofs">notebook</NotebookNoSol> and the ARC blog [post](https://www.lesswrong.com/posts/SyeQjjBoEC48MvnQC/formal-verification-heuristic-explanations-and-surprise).
...
* Work through the intro <NotebookNoSol name="compact_proofs">notebook</NotebookNoSol>
