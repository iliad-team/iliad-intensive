...
* Go over the slides of Lecture 1a. Skip the section you are familiar with. Read the ones you are not familiar with. If you have time do one of the Colab exercises.
