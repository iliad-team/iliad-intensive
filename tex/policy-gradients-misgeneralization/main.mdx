...
Work through the provided [colab notebook](https://colab.research.google.com/github/iliad-team/iliad-intensive-D.2/blob/build/part6_goalmisgen/2.6_Specification_Gaming_and_Goal_Misgeneralisation_exercises.ipynb) on Goal Misgeneralisation.
* The network is again small, but some of the later runs might be slow without a GPU, so we would recommend against running this locally unless you have a GPU in your laptop.