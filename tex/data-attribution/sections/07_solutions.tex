...
\subsection{Solutions to exercises from Section~\ref{sec:causality}}

\paragraph{Solution to Exercise~\ref{ex:croissant-loo} (Leave-one-out attribution for croissants).}

\subsection{Solutions to exercises from Section~\ref{sec:influence}}

\paragraph{Solution to Exercise~\ref{ex:if-derive} (Derivation of the influence function).}
...
\paragraph{Solution to Exercise~\ref{ex:ols-if} (Linear regression).}
...
\paragraph{Solution to Exercise~\ref{ex:if-degenerate} (Failure of the first-order approximation in a degenerate model).}
...
\paragraph{Solution to Exercise~\ref{ex:bif-covariance} (The BIF is a covariance).}
...
\paragraph{Solution to Exercise~\ref{ex:bif-expansion} (Power series expansion of Bayesian influence functions).}
...
\paragraph{Solution to Exercise~\ref{ex:bif-ot} (Influence functions as optimal parameter shifts).}
...
\paragraph{Solution to Exercise~\ref{ex:unroll-derive} (Derivation of the unrolling formula).}
...
\paragraph{Solution to Exercise~\ref{ex:unroll-to-if} (Convergence of unrolling to influence functions).}
...
\paragraph{Solution to Exercise~\ref{ex:dln-influence} (Stagewise influence in a deep linear network).}
