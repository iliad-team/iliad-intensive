...
\subsection{Solutions to exercises from Section~\ref{sec:influence}}\label{subsec:sol-influence}
...
\subsection{Solutions to exercises from Section~\ref{sec:bayesian-if}}\label{subsec:sol-bayesian}
...
\subsection{Solutions to exercises from Section~\ref{sec:unrolling}}\label{subsec:sol-unrolling}
