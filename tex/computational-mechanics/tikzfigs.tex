...
\begin{tikzpicture}\hierarchysets{0}{0}\end{tikzpicture}}

\newcommand{\figHierarchyGreen}{%
\begin{tikzpicture}\hierarchysets{1}{1}\end{tikzpicture}}

% The same sets on the scope slide: shaded, but no asterisk and no arrows.
\newcommand{\figProcessSets}{%
\begin{tikzpicture}\hierarchysets{1}{0}\end{tikzpicture}}
...
\newcommand{\hierarchykey}{%
  ...
  \end{tabular}\par\vspace{0.9em}
  {\footnotesize (non-exhaustive)}}
...
\begin{tikzpicture}
  ...
  % each block adds back into the stream: a circle-plus, not the flattened
  % glyph the handwritten sketch uses for it
