...
% One class boundary: an oval sitting on the common bottom point at the
% origin.  (\ring is taken -- it is LaTeX's ring accent.)
% #1 half-width, #2 height, #3 extra style.
\newcommand{\classring}[3]{%
  \draw[ring,#3] (0,{(#2)/2}) ellipse[x radius=#1, y radius={(#2)/2}];}
...
\begin{tikzpicture}
  ...
  \node[unit] (att) at (1.75,1.30) {Attn};
