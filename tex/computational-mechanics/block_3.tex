\emph{Below are exercises accompanying the \href{https://drive.google.com/file/d/1IPz8Pq939VbjmVqYcYDybdJ02yvdgMGS/view?usp=sharing}{lecture} on prediction. Building on your GHMM implementation from \href{https://drive.google.com/file/d/1Tzw4vSpUixbJLt_Wet9ElZM10DTIpSqa/view?usp=sharing}{Block 2}, you will now compute belief states and next-token vectors, and use them to probe the predictive structure of canonical processes (Z1R, Mess3, RRXOR). Spend \textasciitilde30 minutes on these exercises; start with the core set, and progress to the extension if you have time.}
