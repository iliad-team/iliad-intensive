...
%  Diagrams are drawn in TikZ -- see ./tikzfigs.tex.  ./fig/ holds only
%  what cannot be redrawn: the illustrations, the clipart, and the two
%  third-party figures credited on the images themselves.
%
...
\usepackage{array}
\usepackage{colortbl}    % arydshln takes its rule colour from here
\usepackage{arydshln}    % the pencil grid ruled across the handwritten matrices
\setlength\dashlinedash{2.2pt}
\setlength\dashlinegap{1.7pt}
...
\begin{frame}{Processes:}
  ...
  \begin{columns}[c]
    \begin{column}{0.40\textwidth}
      \begin{center}\resizebox{!}{0.50\textheight}{\figHierarchy}\end{center}
    \end{column}
...
\begin{frame}{Processes:}
  ...
  \begin{columns}[c]
    \begin{column}{0.40\textwidth}
      \begin{center}\resizebox{!}{0.52\textheight}{\figHierarchyGreen}\end{center}
    \end{column}
    \begin{column}{0.56\textwidth}
      {\small\hierarchykey}
    \end{column}
...
\begin{frame}{Overview --- where is the program at?}
  ...
  \begin{center}\resizebox{!}{0.62\textheight}{\figPareto}\end{center}
\end{frame}
...
\begin{frame}{Overview --- where is the program at?}
  ...
  We are working to push the Pareto frontier:
  \begin{center}\resizebox{!}{0.62\textheight}{\figPareto}\end{center}
  % Overlaid, not inserted. A tcolorbox in the flow makes the body taller,
  % beamer re-centres it, and the title line and plot slide down the slide --
  % the original keeps them exactly where the previous frame has them.
  \begin{tikzpicture}[remember picture, overlay]
    \node[anchor=north, inner sep=0pt]
      at ([yshift=-0.315\paperheight]current page.north) {%
...
\begin{frame}{Scope --- what will we tackle today?}
  ...
  \begin{columns}[c]
    \begin{column}{0.46\textwidth}
      \begin{center}
        \uw{Processes}\\[0.6em]
        \resizebox{!}{0.46\textheight}{\figProcessSets}\\[0.5em]
        GHMMs
      \end{center}
    \end{column}
    \begin{column}{0.46\textwidth}
      \begin{center}
        \uw{Models}\\[0.6em]
        \resizebox{!}{0.46\textheight}{\figTransformer}\\[0.5em]
        Transformers
      \end{center}
    \end{column}
  \end{columns}
...
\begin{frame}
  ...
  \begin{columns}[c]
    \begin{column}{0.26\textwidth}
      \[ S = \{s_0\} \]
      \[ \mathcal{X} = \{{\color{red}\mathtt{0}},{\color{red}\mathtt{1}}\} \]
    \end{column}
    \begin{column}{0.36\textwidth}
      \begin{center}\scalebox{0.80}{\figExOneCoin}\end{center}
    \end{column}
    \begin{column}{0.30\textwidth}
      \[ T^{({\color{red}\mathtt{0}})} = {\color{blue}1-p} \]
      \[ T^{({\color{red}\mathtt{1}})} = {\color{blue}p} \]
    \end{column}
  \end{columns}
  ...
  \begin{columns}[c]
    ...
    \begin{column}{0.38\textwidth}
      \[
        T^{({\color{red}\mathtt{0}})} =
        \begin{array}{@{}c@{}}
          \begin{array}{@{}c@{}c@{}c@{}}\lc{s_0}&\lc{s_1}&\lc{s_R}\\\hdashline\end{array}\\[0.1em]
  ...
  \begin{columns}[c]
      ...
      \[
        ...
        \begin{array}{@{}c@{}}
          \begin{array}{@{}c@{}:c@{}c@{}:c@{}c@{}}
            \lcs{s_\emptyset}&\lcs{s_0}&\lcs{s_1}&\lcs{s_F}&\lcs{s_T}\\\hdashline\end{array}\\[0.1em]
          \left[\begin{array}{@{}c@{}:c@{}c@{}:c@{}c@{}}
            \ecs{0}&\ecs{\color{blue}1-p}&\ecs{0}&\ecs{0}&\ecs{0}\\\hdashline
            \ecs{0}&\ecs{0}&\ecs{0}&\ecs{\color{blue}1-q}&\ecs{0}\\
            \ecs{0}&\ecs{0}&\ecs{0}&\ecs{0}&\ecs{\color{blue}1-q}\\\hdashline
    ...
    \begin{column}{0.49\textwidth}
      \[
        T^{({\color{red}\mathtt{1}})} =
        \left[\begin{array}{@{}c@{}:c@{}c@{}:c@{}c@{}}
          \ecs{0}&\ecs{0}&\ecs{\color{blue}p}&\ecs{0}&\ecs{0}\\\hdashline
          \ecs{0}&\ecs{0}&\ecs{0}&\ecs{0}&\ecs{\color{blue}q}\\
          \ecs{0}&\ecs{0}&\ecs{0}&\ecs{\color{blue}q}&\ecs{0}\\\hdashline
          \ecs{0}&\ecs{0}&\ecs{0}&\ecs{0}&\ecs{0}\\
          \ecs{1}&\ecs{0}&\ecs{0}&\ecs{0}&\ecs{0}
        \end{array}\right]
      \]
...
\begin{frame}
  ...
  \begin{columns}[c]
    \begin{column}{0.49\textwidth}
      \[
        \widetilde{T}^{({\color{red}\mathtt{0}})} =
        \begin{array}{@{}c@{}}
          \begin{array}{@{}c@{}c@{}c@{}c@{}}
            \lc{s_0}&\lc{s_1}&\lc{s_2}&\lc{s_R}\\\hdashline\end{array}\\[0.1em]
    ...
    \begin{column}{0.49\textwidth}
      \[
        \widetilde{T}^{({\color{red}\mathtt{1}})} =
        \left[\begin{array}{@{}c@{}c@{}c@{}c@{}}
          \ec{0}&\ec{0}&\ec{0}&\ec{0}\\
...
\begin{frame}
  ...
  \begin{columns}[c]
    \begin{column}{0.49\textwidth}
      {\small\[
        T^{({\color{red}\mathtt{0}})} = \left[\begin{array}{@{}ccc@{}}
    ...
    \begin{column}{0.49\textwidth}
      {\small\[
        T^{({\color{red}\mathtt{1}})} = \left[\begin{array}{@{}ccc@{}}
          {\color{blue}\tfrac14} & 0 & {\color{blue}-2\alpha\beta\gamma^{2}}\\[0.15em]
          0 & {\color{blue}(\alpha^{2}-\beta^{2})\gamma^{2}} & 0\\[0.15em]
          {\color{blue}-2\alpha\beta\gamma^{2}} & 0 & {\color{blue}\tfrac14}
        \end{array}\right]
  ...
  \begin{columns}[c]
    \begin{column}{0.49\textwidth}
      {\small\[
        T^{({\color{red}\mathtt{2}})} = \left[\begin{array}{@{}ccc@{}}
    ...
    \begin{column}{0.49\textwidth}
      {\small\[
        T^{({\color{red}\mathtt{3}})} = \left[\begin{array}{@{}ccc@{}}
          {\color{blue}\tfrac14} & {\color{blue}-2\alpha\beta\gamma^{2}} & 0\\[0.15em]
          {\color{blue}-2\alpha\beta\gamma^{2}} & {\color{blue}\tfrac14} & 0\\[0.15em]
          0 & 0 & {\color{blue}(\alpha^{2}-\beta^{2})\gamma^{2}}
        \end{array}\right]
