...
%  Figures are cropped from the source PDF and live in ./fig/
%
...
\begin{frame}{What is a hidden Markov Model?}
  ...
  process transitions:
  \begin{center}
    \raisebox{-0.45\height}{\includegraphics[height=0.10\textheight]{notation}}
    \hspace{3em}
    $p = P(x,\ s_j \mid s_i)$
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{columns}[c]
    ...
    \begin{column}{0.36\textwidth}
      \begin{center}\includegraphics[width=0.88\linewidth]{ex1_coin}\end{center}
    \end{column}
  ...
  \begin{columns}[c]
    ...
    \end{column}
    \begin{column}{0.30\textwidth}
      \begin{center}\includegraphics[width=0.70\linewidth]{ex2_z1r}\end{center}
    \end{column}
...
\begin{frame}
  ...
  \begin{columns}[c]
    ...
    \begin{column}{0.60\textwidth}
      \begin{center}\includegraphics[width=0.68\linewidth]{ex3_rrxor}\end{center}
    \end{column}
  \end{columns}
...
\begin{frame}
  ...
  \begin{columns}[c]
    ...
    \begin{column}{0.52\textwidth}
      \begin{center}\includegraphics[width=0.56\linewidth]{ex4}\end{center}
    \end{column}
  \end{columns}
...
\begin{frame}
  ...
  \begin{columns}[c]
    ...
    \begin{column}{0.64\textwidth}
      \begin{center}\includegraphics[width=\linewidth]{ex4_redundant}\end{center}
    \end{column}
  \end{columns}
...
\begin{frame}{HMM minimality \& uniqueness}
  ...
  \begin{center}
    \includegraphics[width=0.94\textwidth]{minimality}
  \end{center}
\end{frame}
