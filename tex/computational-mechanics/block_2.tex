\emph{Below are exercises accompanying the \href{https://iliad-team.github.io/iliad-intensive/downloads/computational-mechanics/computational-mechanics-slides.pdf}{lecture} on hidden Markov models (HMMs). In this session, you will implement a GHMM from scratch and use it to compute the probability of observed token sequences -- the foundational machinery you will build on in later blocks. Spend \textasciitilde30 minutes on these exercises; start with the core set, and progress to the extension if you have time.}
