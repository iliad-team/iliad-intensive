...
\item
  ...
  \begin{enumerate}
  \item
    {[}\href{https://iliad-team.github.io/iliad-intensive/downloads/computational-mechanics/computational-mechanics-slides.pdf}{Lecture Slides} \& \href{https://drive.google.com/file/d/1Tzw4vSpUixbJLt_Wet9ElZM10DTIpSqa/view?usp=sharing}{Exercise Sheet}{]} \textbf{Hidden Markov Models (HMMs)}
...
\section{Identifying belief geometry in transformers}
\input{block_4}

\section{Designing processes}
\input{block_5}

\section{How do transformers do it?}
\input{block_6}
