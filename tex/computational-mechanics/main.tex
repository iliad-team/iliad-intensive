...
\textbf{Mathematical background.} The module is mathematically self-contained -- all formal definitions (HMMs, GHMMs, belief states, MSPs) are introduced from scratch. However, students will engage with the material more fluently if they are comfortable with the following:
...
\begin{enumerate}
\item
  {[}\href{https://drive.google.com/file/d/1WLq5UeXhHGzsmjrSr9A24NXkJxbSUvpE/view?usp=sharing}{Lecture slides}{]} \textbf{Overview and scope}
...
\item
  ...
  \begin{enumerate}
  \item
    {[}\href{https://drive.google.com/file/d/1Hjaih2AtPfMRurSqMUm7IKthmo8R8qlc/view?usp=sharing}{Lecture Slides} \& \href{https://drive.google.com/file/d/1Tzw4vSpUixbJLt_Wet9ElZM10DTIpSqa/view?usp=sharing}{Exercise Sheet}{]} \textbf{Hidden Markov Models (HMMs)}
    ...
    \end{enumerate}
  \item
    {[}\href{https://drive.google.com/file/d/1IPz8Pq939VbjmVqYcYDybdJ02yvdgMGS/view?usp=sharing}{Lecture slides} \& \href{https://drive.google.com/file/d/1tfUC7uZ8TWqNqPpjH87nsXp2vQ52m3Wt/view?usp=sharing}{Exercise Sheet}{]} \textbf{Prediction}
...
\item
  ...
  \begin{enumerate}
  \item
    {[}\href{https://drive.google.com/file/d/1eifwRe-a7ZT-7lSDJqe2YUSekwgbIFND/view?usp=sharing}{Tutorial Sheet}{]} \textbf{Designing processes worth studying}
    ...
    \end{enumerate}
  \item
    {[}\href{https://drive.google.com/file/d/1c_rzbR1s9N0QkpaSWcLOKUjNEIasv22y/view?usp=sharing}{Reading guide}{]} \textbf{Identifying belief geometry in transformers}
    ...
    \end{enumerate}
  \item
    {[}\href{https://drive.google.com/file/d/1TiiW-n11CAPQ1CueK5_1BvidAeldofwp/view?usp=sharing}{Tutorial Sheet}{]} \textbf{How do transformers do it?}
...
\section{Block 2: Hidden Markov models}
\input{block_2}

\section{Block 3: Prediction}
\input{block_3}

\section{Block 4: Identifying belief geometry in transformers}
\input{block_4}

\section{Block 5: Designing processes}
\input{block_5}

\section{Block 6: How do transformers do it?}
\input{block_6}
