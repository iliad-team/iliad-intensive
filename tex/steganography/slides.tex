...
\begin{frame}{Steganography Setup}
    ...
    % TODO add figure: img/stego_schematic.png is not in the source hand-over.
% TODO add figure:     \begin{figure}
% TODO add figure:         \includegraphics[width=0.6\textwidth]{img/stego_schematic.png}
% TODO add figure:     \end{figure}
...
\begin{frame}{Can we have perfect perfect information theoretic security?}
    ...
    % TODO add figure: img/Message_entropy.png is not in the source hand-over.
% TODO add figure:     \begin{figure}
% TODO add figure:         \includegraphics[width=0.4\textwidth]{img/Message_entropy.png}
% TODO add figure:     \end{figure}
