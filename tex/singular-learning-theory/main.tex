...
% Matthew's recorded lecture for this day. Explicit title: the video is
% scheduled and not yet public, so the oEmbed lookup 403s until it premieres;
% the player unlocks by itself when it goes live.
\youtube[Deep Learning Is Singular - Here's What That Means]{SzVmiN8BvCc}
