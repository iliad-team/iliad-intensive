...
\begin{enumerate}
    ...
    \item
        ...
        $n^*/\log n^*$ is monotonically increasing for $n > e$ so for such $n$, increasing $|\Delta \lambda|$ increases $n^*$ and increasing the magnitude of $\Delta L$ decreases $n^*$.
