...
% summary: >-
%   Through countless weights, one function stays the same;
%   The learning cost is marked by lambda's term.
%   Free energy reveals when phases turn;
%   From Bayes, the phase transitions as we learn.
