...
\begin{exercise}[Loss Landscape Geometry]
\label{ex:td-1}
...
\begin{exercise}[Gradient Flow and Conserved Quantities]
\label{ex:td-2}
...
\begin{exercise}[Rich Regime: saddle-to-saddle]
\label{ex:td-3}
...
\textbf{(a)} Now initialize at a \textbf{large} value \(w_0 \gg s > 0\). Assume that in
...
\begin{exercise}[Mixed Dynamics: Unifying Lazy and Rich]
\label{ex:td-5}
...
\begin{exercise}[Stochastic Implicit Bias (Bonus)]
\label{ex:td-6}
