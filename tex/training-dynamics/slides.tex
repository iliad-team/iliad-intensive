...
% NB: no `block=fill` — the moloch in Ubuntu/CI texlive-latex-extra doesn't
% define that key and errors on it (works in newer TeX Live). Blocks just use
% the default (unfilled) style.
\usetheme[
