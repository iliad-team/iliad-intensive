// slides.typ — the MDX kitchen sink's Typst deck. A deck may be written in
...
#set document(title: "Example Typst deck (MDX)")
#set page(width: 16cm, height: 9cm, margin: 1.2cm, fill: rgb("#f7f3e8"))
#set text(size: 14pt)

#align(center + horizon)[
  #text(size: 26pt, weight: "bold")[Example Typst deck (MDX)]
  #v(0.6em)
