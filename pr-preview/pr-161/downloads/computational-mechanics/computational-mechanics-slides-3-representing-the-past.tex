...
\begin{frame}{The next-token probability vector}
  ...
  \vfill
  % ERRATA 2026-09-16: "slide 10" pointed at the belief-update frame; the
  %   law-of-total-probability expression is frame 9 (footer numbering).
  %   The two speaker notes below and at "HMM definition on slide 6" (frame 5)
  %   were off by one the same way.
  ...
  expression on slide 9, now replacing the posterior term with the belief
...
\begin{frame}{Generalised hidden Markov models}
  ...
  The component list deliberately parallels the HMM definition on slide 5.
